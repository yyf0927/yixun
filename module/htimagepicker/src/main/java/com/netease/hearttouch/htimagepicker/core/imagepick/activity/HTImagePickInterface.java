...
public interface HTImagePickInterface {
     ...
     */
    void onUpdateSelectedImagesFromPreview(List<Image> images);
    ...
    /**
     * 当选择超出时，会回调该接口
     * @param selectedSize   被选中的数量（实际 mSelectedImages 的数量已经被限制在 selectedLimit）
     * @param selectedLimit  选择上限
     */
    void onImageSelectedOverflow(int selectedSize, int selectedLimit);
}
