...
/**
 * Recycle stores wheel mItems to reuse.
 */
public class WheelRecycle {
	...
	/**
	 * Recycles mItems from specified layout. There are saved only mItems not
	 * included to specified range. All the cached mItems are removed from
	 * original layout.
	 * 
	 * @param layout
	 *            the layout containing mItems to be cached
	 * @param firstItem
	 *            the number of first item in layout
	 * @param range
	 *            the range of current wheel mItems
