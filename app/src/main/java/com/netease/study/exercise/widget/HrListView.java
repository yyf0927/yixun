...
public class HrListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public HrListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public HrListView(Context context) {
        super(context);
        initView(context);
    }

    public HrListView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        footer = layoutInflater.inflate(R.layout.list_footer_refresh, null);
